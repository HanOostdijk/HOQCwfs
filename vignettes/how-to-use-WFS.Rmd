...
- retrieve a subset of one of the above: add `maxfeatures=` or `count=` optionally in combination with `startindex=`
...
##### retrieve features in a bounding box
...
##### retrieve features in a bounding box with additional filtering
