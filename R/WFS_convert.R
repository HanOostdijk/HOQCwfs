...
#' Convert coordinates
#'
#' - The function `convert_bbox` converts a bbox from one CRS to another
...
#' @return The `convert_bbox` returns a numeric vector and the  `convert_points` returns a numeric matrix with two columns
#' @examples
